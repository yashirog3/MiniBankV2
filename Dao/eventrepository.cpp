...
ClientAccounts * EventRepository::getClient(int ClientId)
{
...
ClientAccount * EventRepository::getClientAccount(int ClientId, int AccountId)
{
    //Get Client
...
bool EventRepository::CheckCollision(int ClientId, int AccountId, int Version)
{
...
bool EventRepository::Persist(int ClientId, int AccountId, Events * AllEvents, int Version)
{
    try
    {
